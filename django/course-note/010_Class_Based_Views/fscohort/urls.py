...
from .views import HomeView, StudentCreatView, StudentDeleteView, StudentDetailView, StudentListView, StudentUpdateView, home,student_list, student_add, student_detail, student_update,student_delete
...
urlpatterns = [
    ...
    path('student_add/',StudentCreatView.as_view(),name="add"),
